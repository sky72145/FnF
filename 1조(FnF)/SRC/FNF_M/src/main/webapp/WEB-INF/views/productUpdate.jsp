    ...
    $(function(){
		...
		//img 파일이 아닐 때
		 $("#file1").change(function(){
			 if($("#file1").val().split(".")[1] != "jpg" && $("#file1").val().split(".")[1] != "png" &&  $("#file1").val().split(".")[1] != "PNG" &&  $("#file1").val().split(".")[1] != "JPG"){
				 alert("이미지 파일을 올려주세요.");
				 $("#file1").val("");
			 } 
		 });
	    ...
	    //btnUpdate 눌렀을 때
		 $("#btnUpdate").click(function(){
			if(20 < $("#pcode").val().replace(/[\0-\x7f]|([0-\u07ff]|(.))/g,"$&$1$2").length){
				 $("#pcode").focus();
...
">
	<div id="wrapper" style="padding-left: 300px; padding-right: 300px;">
		...
		<h1 style="padding-top: 20px;">상품관리</h1>
			...
			<h3>상품수정</h3>
			<hr>
			<form id="frm" action="/sellerPU/${product.idx }" method="POST" enctype="multipart/form-data" onsubmit="return false;">
...
<!-- 					<input type="hidden" name="sellerid"  id="sellerid" value="김민호"/> -->
					...
					<div class="input-group">
					  ...
					  <input type="number" class="form-control"  name="stock"  id="stock" 
					  		value="${product.stock}" aria-describedby="sizing-addon2" placeholder="재고"  min="1" max="99999" required>
					</div>
					<br>
					<div class="input-group">
					  <span class="input-group-addon" id="sizing-addon2">판매가</span>
					  <input type="number" class="form-control"  name="price" id="price"  
					  		value="${product.price}"  aria-describedby="sizing-addon2" placeholder="판매가" min="1" max="99999999" required>
					</div>
					<br>
