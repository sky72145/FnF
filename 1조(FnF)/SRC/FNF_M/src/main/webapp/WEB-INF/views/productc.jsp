					...
					<div class="aa-product-catg-content">
						<div class="aa-product-catg-body">
							<ul class="aa-product-catg">
								...
								<c:forEach items="${productc }" var="product">
									<li>
										<figure>
											<a class="aa-product-img"
												href='/PD/<c:out value="${product.idx}"/>'><img
												src='/static/img/<c:out value="${product.filename}"/>'
												alt="afasgaw"></a>
											<figcaption>
												<h4 class="aa-product-title">
													<a href='/PD/<c:out value="${product.idx}"/>'><c:out
								...
								<ul class="pagination">
									<c:if test="${pageMaker4.prev}">
										<li class="paginate_button previous"><a
											href='/productc?pageNum=${pageMaker4.startPage -1}&amount=9'>Previous</a></li>
									</c:if>

									<c:forEach var="num" begin="${pageMaker4.startPage}"
										end="${pageMaker4.endPage}">
										<li
											class="paginate_button  ${pageMaker4.cri3.pageNum == num ? "active":""} ">
											<a href='/productc?pageNum=${num}&amount=9'>${num}</a>
										</li>
									</c:forEach>

									<c:if test="${pageMaker4.next}">
										<li class="paginate_button next"><a
											href='/productc?pageNum=${pageMaker4.endPage +1 }&amount=9'>Next</a></li>
									</c:if>
								</ul>
							</nav>
						</div>
					...
					<aside class="aa-sidebar">
						...
						<div class="aa-sidebar-widget">
							...
							<ul class="aa-catg-nav">
								<li><a href='/products?category=농산물&pageNum=1&amount=9'>농산물</a></li>
								<li><a href='/products?category=수산물&pageNum=1&amount=9'>수산물</a></li>
								<li><a href='/products?category=가공식품&pageNum=1&amount=9'>가공식품</a></li>
								<li><a href='/productc?pageNum=1&amount=9'>추천상품</a></li>
								<li><a href='/productf?pageNum=1&amount=9'>인기상품</a></li>
							</ul>
						</div>
						<!-- single sidebar -->
						<div class="aa-sidebar-widget">
							<h3>Tags</h3>
							<div class="tag-cloud">
								<a href='/products2?category2=채소&pageNum=1&amount=9'>채소</a> <a
									href='/products2?category2=과일&pageNum=1&amount=9'>과일</a> <a
									href='/products2?category2=쌀,잡곡류&pageNum=1&amount=9'>쌀,잡곡류</a>
								<a href='/products2?category2=견과류&pageNum=1&amount=9'>견과류</a> <a
									href='/products2?category2=생선&pageNum=1&amount=9'>생선</a> <a
									href='/products2?category2=갑각류&pageNum=1&amount=9'>갑각류</a> <a
									href='/products2?category2=해조류&pageNum=1&amount=9'>해조류</a> <a
									href='/products2?category2=건어물&pageNum=1&amount=9'>건어물</a> <a
									href='/products2?category2=즙류&pageNum=1&amount=9'>즙류</a> <a
									href='/products2?category2=분말류&pageNum=1&amount=9'>분말류</a> <a
									href='/products2?category2=잼류&pageNum=1&amount=9'>잼류</a>
							</div>
						</div>
						<!-- single sidebar -->
						<div class="aa-sidebar-widget">
