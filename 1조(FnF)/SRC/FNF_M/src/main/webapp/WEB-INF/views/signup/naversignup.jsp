								...
								<div class="aa-memberlogin-login" ng-app="ngRequiredApp" ng-controller="ngRequiredCtrl">
									...
									<form action="login" method="post">
										...
										<div class="col-sm-4" id="divInputemail">
											<input type="email" class="form-control" name="email" id="email" value="${customerVo.email}" readonly/>
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="user_name" name="user_name" value="${customerVo.user_name}" readonly />
