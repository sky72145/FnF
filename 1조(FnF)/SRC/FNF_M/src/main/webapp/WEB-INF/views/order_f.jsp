	...
	<div class="container" >
		<table class="table table-sm text-center border bg-light">
    		...
    		<div class="col align-self-start">
     			<p class="text-primary h4"><strong>결제 정보</strong></p>
    		</div>
    		<table class="table  table-sm table-bordered td">
    			<tr>
    				<td class="align-middle active"><strong>최종결제금액</strong></td><td><div><fmt:formatNumber value="${vo.totalprice}" pattern="#,###.##" />원</div></td>
    			</tr>
    			<tr>
    		...
    		<div class="col align-self-start">
     			<p class="text-primary h4"><strong>주문 상품 정보</strong></p>
    		</div>
			...
			<tbody>
				<c:forEach items="${cartList}" var="cart">
						...
						<fmt:formatNumber var="product_mil" value="${product_sum * 0.01}" type="number" maxFractionDigits="0" />
		...
		<table class="table text-center h4">
			 	<tr class="active">
			 		<th class="text-center">총 상품금액</th><th class="text-center">배송비</th><th class="text-center">적립금 사용금액</th><th class="text-center">총 결제금액</th>
			 	</tr>
			 	<tr class="h3">
			 ...
			 <div class="col align-self-start">
     			<p class="text-primary h4"><strong>배송지정보</strong></p>
    		 </div>
			 <table class="table table-sm border-left border-right border-bottom">
    		<tr>
    			<td class="p-2 pl-3 active"><strong>받는분 : </strong></td><td class="border-right">${vo.receiver_name }</td>
    		</tr>
    		<tr>
    			<td class="p-2 pl-3 active"><strong>우편번호 : </strong></td><td class="border-right">${vo.zipcode }</td>
    		</tr>
    		<tr>
    			<td class="p-2 pl-3 active align-middle" rowspan="2 "><strong>주소 : </strong></td><td colspan="2"> ${vo.address1 }</td>
    		</tr>
    		<tr>
    			<td colspan="2">  ${vo.address2 }</td>
    		</tr>
    		<tr>
    			<td class="p-2 pl-3 active"><strong>휴대전화 : </strong></td><td colspan="2"> ${vo.phone }</td>
    		</tr>
    		<tr>
    			<td class="p-2 pl-3 active"><strong>이메일 : </strong></td><td colspan="2"> ${vo.email }</td>
    		</tr>
    		<tr>
    			<td class="p-2 pl-3 active"><strong>배송 메세지 : </strong></td><td colspan="2">${vo.del_message}</td>
    		</tr>
    			
	</table>

		<div  class="text-center">
			<input type="button" class="btn btn-dark" value="주문확인하기 " onclick="location.href='/myorder?user_id=${user_id}'">&nbsp;&nbsp;&nbsp;
