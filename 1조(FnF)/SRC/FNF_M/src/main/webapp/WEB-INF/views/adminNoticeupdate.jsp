...
<form name="myform" id="myform">
	...
	<div class="form-group writer">
		...
		<div class="col-md-offset-2 col-sm-10">
			<input class="form-control " id="user_id" name="user_id" placeholder="작성자" type="text" value="${notice.user_id}" readonly>
		</div>
	</div>
	...
	<div class="form-group writer">
		<!-- <label class="control-label col-sm-offset-1 col-sm-1 title" for="bda_title">제목</label> -->
		<div class="col-md-offset-2 col-sm-10">
			<input class="form-control " id="txtTitle" name="title" type="text" value="${notice.title}" autofocus required>
		</div>
	</div>
	...
	<div class="form-group writer">
		...
		<div class="col-md-offset-2 col-sm-10">
			<textarea class="form-control" id="txtContents" name="contents" rows="20" required style="resize: none;">${notice.contents}</textarea>
		</div>
	</div>
			...
			<table border="1"  style="color: d2d2d2;" id="attached">
				<tbody class="">
					<tr>
						...
						<td rowspan="3">
							<img src="../../../img/fileupload/${notice.filename}" width="250px" height="150px"/>
							<input type="hidden" name="file1" id="file1" value="${notice.filename}" />
						</td>
					</tr>
						<!-- <tr>
							<th scope="row">
	...
	<div class="col-sm-offset-3 col-md-9">
	 ...
	 <button type="button" class="btn btn-info writerbtn" id = "btnBack" onclick="history.back()">돌아가기</button> 
	 </div> 
</div>
</form>
</div>
