	...
	/* 데이터 입력 */
 	$(function() {
		$("#btnSignup").bind("click", function() {	
			if ($("#checkbox1").prop("checked") == true && $("#checkbox2").prop("checked") == true && $("#checkbox3").prop("checked") == true && $("#checkbox4").prop("checked") == true 
				&& $("#regi_num").val().length > 0 && $("#answer").val().length > 0) {
			$.ajax({
				url : "signupse/",
				method : "POST",
				dataType : "json",
