	...
	<table class="table">
		 <div class="row">
    		<div class="col align-self-start">
     			<p class="text-primary h4 strong"><strong>주문상품</strong></p>
    		</div>
...
<table class="table table-bordered">
		 <div class="row">
    		<div class="col align-self-start">
     			<p class="text-primary h4 strong"><strong>배송지 정보</strong></p>
    		</div></div>
    		<c:forEach items="${plist}" var="cart">
    		<input type="hidden" name="pcode" value="${cart.pcode }" />
    		</c:forEach>
    		<tr>
    			<td class="p-3 mb-2 active"><strong>받는분 : </strong><img src="img/ico_required.gif" alt="필수"></td><td><input type="text" name="receiver_name" id="receiver_name" size="10" value="${user.user_name }"> <input type="button" id="useraddress" class="btn btn-default" value="최근배송지" onclick="addr();"></td>
    		</tr>
    		<tr>
    			<td class="p-3 mb-2 active"><strong>우편번호 : </strong><img src="img/ico_required.gif" alt="필수"></td><td><input type="text" name="zipcode" id="zipcode"  size="10" readonly>&nbsp;<input type="button" class="btn btn-default" name="zipbtn" value="우편번호" onclick="dzip();"></td>
    		</tr>
    		<tr>
    			<td class="p-3 mb-2 active" rowspan="2 "><strong>주소 : </strong><img src="img/ico_required.gif" alt="필수"></td><td colspan="2"><input type="text" name="address1" id="address1" size="60" readonly> 기본주소</td>
    		</tr>
    		<tr>
    			<td colspan="2"><input type="text" name="address2" id="address2" size="60" > 나머지 주소</td>
    		</tr>
    		<tr>
    			<td class="p-3 mb-2 active"><strong>휴대전화 : </strong><img src="img/ico_required.gif" alt="필수"></td><td colspan="2"><input type="text" name="phone" id="phone" value="${user.phone }"></td>
    		</tr>
    		<tr>
    			<td class="p-3 mb-2 active"><strong>이메일 : </strong><img src="img/ico_required.gif" alt="필수"></td><td colspan="2"><input type="email" name="email" id="email" value="${user.email }"></td>
    		</tr>
    		<tr>
    			<td class="p-3 mb-2 active"><strong>배송 메세지 : </strong></td><td colspan="2"><textarea cols="70" maxlength="20" name="del_message" id="del_message" style="resize: none;"></textarea>
...
<div class="row">
        <div class="col align-self-start">
          <p class="text-primary h4 strong"><strong>적립금 사용</strong></p>
        </div>
...
<!-- 이용약관 -->
    		<div class="col align-self-start ">
     			<p class="text-primary h4 strong"><strong>쇼핑몰 이용약관 동의</strong></p>
    		</div>
  <!--  <table class="table"> -->
  ...
  <!--  </table> -->
   ...
   <!-- 결제예상금액 -->
   <div class="col align-self-start">
     			<p class="text-primary h4 strong"><strong>결제 예상 금액</strong></p>
    	</div>
    		<table class="table">
    		<tr>
    ...
    <!-- 결제수단 -->
    <div class="col align-self-start">
     			<p class="text-primary h4"><strong>결제 수단</strong></p>
    </div>
    <div  class="ml-5 mt-3">
    	<table class="table table-bordered">
    	<tr>
    		<td class="col-md-2">
    		<input type="radio" value="무통장" name="pay" id="pay" checked="checked" onclick="javascript:contentsView(pay);" ><img style="padding:5px" src="img/input.gif"><br />
    	...
    	<td>
    	 <div id="bank" class="h5">
          ...
          <div class="text-center p-3">
          	<input type="button" class="btn btn-default btn-lg" value="뒤로가기" onclick="history.back()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          	 <input type="button" class="btn btn-primary btn-lg" value="결제하기" onclick="f_save()">
