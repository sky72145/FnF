  ...
  var page = null;
	...
	function display(result){
		...
		for(var i = 0 ; i < count ; i++){
			...
			str += "<td>" + grp + "</td>";
			if(parseInt(qaa.status) == 1 && parseInt(qaa.reply_status) > 0){
				str += "<td>&nbsp;"  + "<span class='glyphicon glyphicon-lock' aria-hidden='true'></span><a onclick='checkTitle("+qaa.idx+","+page+","+qaa.status+","+password+")' href='javascript:void(0)'";
				str += ">" + qaa.title + "</a>&nbsp;&nbsp;<span class='glyphicon glyphicon-ok' aria-hidden='true'></span></td>";	
			}else if(parseInt(qaa.reply_status) > 0 && parseInt(qaa.status) == 0){
				str += "<td>&nbsp;"  + "<a onclick='checkTitle("+qaa.idx+","+page+","+qaa.status+","+password+")' href='javascript:void(0)'";
				str += ">" + qaa.title + "</a>&nbsp;&nbsp;<span class='glyphicon glyphicon-ok' aria-hidden='true'></span></td>";
			}else if(parseInt(qaa.status) == 1 && parseInt(qaa.reply_status) <= 0){
				str += "<td>&nbsp;"  + "<span class='glyphicon glyphicon-lock' aria-hidden='true'></span><a onclick='checkTitle("+qaa.idx+","+page+","+qaa.status+","+password+")' href='javascript:void(0)'";
				str += ">" + qaa.title + "</a></td>";	
			}else{
				str += "<td>&nbsp;"  + "<a onclick='checkTitle("+qaa.idx+","+page+","+qaa.status+","+password+")' href='javascript:void(0)'";
	...
	function checkTitle(idx,page,status,password){
		 if(status==0)
			location.href = "/qaa/"+page+"/"+idx;
		else if(status==1){
							...
							<div class="col-md-offset-1 col-md-10">
								...
								<div class="sd-blog-content" >
									<div class="col-sm-2 aa-login-form">
										<button class="btn btn-primary" type="button" onclick="location.href='qaa/qaawrite'" id="write"> 글쓰기</button>
									</div>
								</div> 
