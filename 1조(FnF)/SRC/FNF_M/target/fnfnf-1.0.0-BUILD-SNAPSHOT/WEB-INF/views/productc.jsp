						...
						<nav>
							<ul class="pagination">
								...
								<c:forEach var="num" begin="${pageMaker4.startPage}"
									...
									<li class="paginate_button  ${pageMaker4.cri3.pageNum == num ? "active":""} ">
					...
					<div class="aa-sidebar-widget">
						...
						<div class="tag-cloud">
							<a href='/products2?category2=채소&pageNum=1&amount=9'>채소</a> <a
								...
								href='/products2?category2=쌀,잡곡류&pageNum=1&amount=9'>쌀,잡곡류</a> <a
								href='/products2?category2=견과류&pageNum=1&amount=9'>견과류</a> <a
