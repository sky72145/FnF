...
function display(result) {
	...
	if (count == 0) {
		...
		for (var i = 0; i < count; i++) {
            ...
            str +="<td>"+writedate+"</td>";
            str +="<td>";			//    /viewSMSG/{idx}
            str +="    <a href='/viewSMSG/"+result[i].idx+"'><button class='btn btn-info btn-xs'  type='button' title='보기'><span class='glyphicon glyphicon-eye-open' aria-hidden='true'></span></button></a>";
