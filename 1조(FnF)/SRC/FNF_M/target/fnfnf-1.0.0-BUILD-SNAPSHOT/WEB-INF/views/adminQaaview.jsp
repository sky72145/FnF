					...
					<div class="aa-blog-content"
						...
						<p id="file">
							<c:if test="${qaa.filename != null}">
								<img src="../../img/fileupload/${qaa.filename}" width="600px"
									height="400px">
							</c:if>
							<c:if test="{qaa.filename == null}">
								<span></span>
						...
						<div class="row col-sm-offset-4 col-sm-8" id="btnarea">
							...
							<div class="col-sm-2 aa-login-form">
								<button class="btn btn-primary" type="button"
									onclick="location.href='/admin/qaa/update/${currentPage}/${currentIdx}'">
									수정</button>
							</div>
							<div class="col-sm-2 aa-login-form">
								<button class="btn btn-primary" type="button" id="btnDelete">
									삭제</button>
							</div>
