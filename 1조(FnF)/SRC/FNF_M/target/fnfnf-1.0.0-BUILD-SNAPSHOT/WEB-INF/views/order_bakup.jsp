...
<table class="table table-bordered">
		 <div class="row">
    		...
    		<tr>
    			<td class="p-3 mb-2 active">받는분 : <img src="img/ico_required.gif" alt="필수"></td><td><input type="text" name="receiver_name" id="receiver_name" size="10" value="${user.user_name }"></td>
    		</tr>
    		<tr>
  ...
  <!--  </table> -->
   ...
   <div class="col align-self-start">
    ...
    <div  class="ml-5 mt-3">
         ...
         <input type="radio" value="무통장" name="pay" id="pay"> 무통장 &nbsp;&nbsp;&nbsp;
          <input type="radio" value="카카오페이" name="pay" id="kpay"> 카카오페이</div>
          ...
          <div class="text-center p-3">
          	<input type="button" class="btn btn-outline-success" value="뒤로가기" onclick="history.back()">
          	 ...
          	 <input type="button" class="btn btn-outline-success" value="결제하기" id="orderd">
