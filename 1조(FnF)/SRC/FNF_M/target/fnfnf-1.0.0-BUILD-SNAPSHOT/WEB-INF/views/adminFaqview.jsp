...
<hr>
	<form>
				...
				<div class="aa-blog-content" style="word-break:break-all;overflow: auto" id=viewform>
					...
					<p id="file">
						<c:if test="${faq.filename != null}" >
							<img src="../../img/fileupload/${faq.filename}" width="600px" height="400px">
						</c:if>
						<c:if test="{faq.filename == null}" >
							<span></span>
						</c:if>
		...
		<div class="row col-sm-offset-4 col-sm-8" id="btnarea">
			...
			<div class="col-sm-2 aa-login-form">
				<button class="btn btn-primary" type="button" onclick="location.href='/admin/faq/update/${currentPage}/${currentIdx}'"> 수정</button>
			</div>
			<div class="col-sm-2 aa-login-form">
