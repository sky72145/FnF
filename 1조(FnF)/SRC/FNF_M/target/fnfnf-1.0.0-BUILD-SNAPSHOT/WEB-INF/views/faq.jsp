...
<div class="fixed_customer_page">
	...
	<div class="banner">
		...
		<ul>
			<li class="xans-record-"><a href="/cs" alt=" "><img class="banner_img"  src="/resources/img/notice.png"></a></li>
			<li class="xans-record-"><a href="faq" alt=" "><img class="banner_img"  src="/resources/img/question.png"></a></li>
			<li class="xans-record-"><a href="qaa" alt=" "><img class="banner_img"  src="/resources/img/qaa.png"></a></li>
		</ul>
	</div>
</div>
</section>
							...
							<div class="col-md-offset-1 col-md-10">
								...
								<div class="sd-blog-content" >
									<div class="col-sm-12 aa-login-form">
										<button class="aa-browse-btn" type="button" onclick="location.href='faq/faqwrite'">글쓰기</button>
									</div>
								</div>
								...
								<a href="#none" onclick="" class="btn btn-primary" id="click">검색</a>
								</div>
