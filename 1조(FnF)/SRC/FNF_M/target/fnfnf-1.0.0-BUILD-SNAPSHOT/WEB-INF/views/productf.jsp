				...
				<div class="aa-product-catg-content">
					<div class="aa-product-catg-body">
						<ul class="aa-product-catg">
							...
							<c:forEach items="${productf }" var="product">
								<li>
									<figure>
							...
							<ul class="pagination">
								<c:if test="${pageMaker4.prev}">
									<li class="paginate_button previous"><a
										href='/productf?pageNum=${pageMaker4.startPage -1}&amount=9'>Previous</a></li>
								</c:if>
								...
								<c:forEach var="num" begin="${pageMaker4.startPage}"
									...
									<li class="paginate_button  ${pageMaker4.cri3.pageNum == num ? "active":""} ">
										<a href='/productf?pageNum=${num}&amount=9'>${num}</a>
									</li>
								</c:forEach>

								<c:if test="${pageMaker4.next}">
									<li class="paginate_button next"><a
										href='/productf?pageNum=${pageMaker4.endPage +1 }&amount=9'>Next</a></li>	
								</c:if>
							</ul>
						</nav>
					</div>
					...
					<div class="aa-sidebar-widget">
						...
						<div class="aa-sidebar-widget">
							...
							<div class="aa-recently-views">
								<ul>
									<c:forEach items="${productsf }" var="productf" begin="0"
										end="2">
