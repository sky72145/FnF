...
<div class="col-md-12">
<div class="row">
<h1 id="faqtitle" ><strong>자주 묻는 질문</strong></h1>
<form name="myform" id="myform">
	...
	<div class="col-sm-offset-3 col-md-9">
	 <button type="button" class="btn btn-success writerbtn" id ="btnWrite">글쓰기</button> &nbsp;
	 <button type="button" class="btn btn-info writerbtn" id = "btnBack" onclick="location.href='/admin/faq' ">돌아가기</button> 
	 </div> 
	 </div>
	 </form>
</div>
