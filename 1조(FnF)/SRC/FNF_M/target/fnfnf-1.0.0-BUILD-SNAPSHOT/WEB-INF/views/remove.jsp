				...
				<div class="wrapper">
					<div class="col-md-10">
						<div class="aa-memberlogin-login">
							...
							<hr width="100%">
							<form action="/remove" id="signupform" name="signupform"
								method="post">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="signupname"
										name="user_name" value='<c:out value="${member.user_name }"/>'
										readonly="readonly" />
								</div>
								...
								<hr width="100%">
								<br />
								<button type="submit" id="btnregister" data-oper='remove'
									class="btn btn-success col-md-offset-4">탈퇴하기</button>
							</form>
						</div>
					</div>
				</div>
